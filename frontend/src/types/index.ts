...
export interface Transcript {
  ...
  speaker?: string;          // Speaker attribution (e.g., "Speaker 1")
}
...
// Diarization types
export type DiarizationStreamingPreset = 'Offline' | 'LowLatency' | 'VeryLowLatency' | 'UltraLowLatency';
