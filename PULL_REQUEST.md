...
- **Mid-Sentence Speaker Splitting**: Transcripts are automatically split into separate turns when speaker handoffs happen within a single recognition window.
...
#### 4. Windows Build & UI Startup Reliability Fixes
